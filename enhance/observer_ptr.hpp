...
#ifndef enhance_OBSERVER_PTR_H_INCLUDED
#define enhance_OBSERVER_PTR_H_INCLUDED
...
template< class T >
struct hash< ::enhance::observer_ptr<T> >
{
    size_t operator()(::enhance::observer_ptr<T> p ) { return hash<T*>()( p.get() ); }
};
...
#endif // enhance_OBSERVER_PTR_H_INCLUDED
