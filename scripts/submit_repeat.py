...
if __name__ == "__main__":
    ...
    sb.makeDirectoryListRepeat(args)
    sb.askPermissionRepeat(args)
    sb.copyConfigFileRepeat(args)
    sb.copyProgramsRepeat(args)
    sb.updateConfigFilesRepeat(args)
    sb.createSubmitScripts(args)
    sb.sbatchAllRepeat(args)