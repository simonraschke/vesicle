...
parser.add_argument('--grid', type=int, default=0, help="grid edge on where to place the frame guides NxNxN")
...
parser.add_argument('--ge', nargs='*', type=int, default=0, help="guiding elements per frame guide value list")
